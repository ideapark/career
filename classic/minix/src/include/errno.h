/*
 * The <errno.h> header defines the number of the various errors that can
 * occur during program execution. The are visible to user programs and
 * should be small positive integers. However, they are also used withing
 ...
 * will be defined, setting EPERM to (- 1), whereas when when this file is
 * included in a ordinary user program, EPERM has the value ( 1).
 */
...
#define ENFILE           (_SIGN 23) /* too many files in system */
#define EMFILE           (_SIGN 24) /* too many files */
