...
#define SIGCHLD        17  /* child process terminated or stoppped */

#define SIGEMT          7  /* obsolete */
#define SIGBUS         10  /* obsolete */

/*
 * MINIX specific signals. These signals are not used by user process,
 * but meant to inform system process, like the PM, about system events.
 */
...
/*
 * POSIX requires the following signals to be defined, event if they are
