...
#define NCCS     20  /* size of cc_c array, some extra
...
/* Indices into c_cc array. Default values in parenthesess. POSIX Table 7-5 */
...
#define _POSIX_VDISABLE (cc_t)0xFF  /* You can't even generate this
                                     ...
                                     * can generate 0xFF. It seems that 256
                                     * are used, so cc_t should be a short...
                                     */
...
#define TCSAFLUSH   3  /* wait for output to finish and flush input data */
 ...
 * confirming programs are not able to access these, and therefore they
 * are only defined when a Minix program is compiled.
 */
...
/*
 * Extensions to the termios c_oflag bit map. They are
 * only active if OPOST is enabled
 */
...
#define TTIME_DEF     0
#define TREPRINT_DEF  '\26' /* ^R */
#define TLNEXT_DEF    '\22' /* ^V */
