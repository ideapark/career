/*
 * The <limits.h> header defines some basic sizes, both of the language type
 * (e.g., the number of bits in an integer), and of the operating system (eg.
 * the number of character in a file name.)
 */

#ifndef _LIMITS_H
#define _LIMITS_H

/* Definitions about chars (8 bit in MINIX, and signed). */
...
#define ARG_MAX          16384 /* # bytes of args + envion for exec() */
#define CHILD_MAX    _NO_LIMIT /* MINIX does not limit children */
#define OPEN_MAX      SHRT_MAX /* # links a file may have */
