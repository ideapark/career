 ...
 * with only the options described in the text, Operating Systems Design
 * and Implementation, 3rd edition. See the sys_config.h in the full
...
#define _MACHINE_IBM_PC  1  /* any 8088 or 80x86-base system */
 ...
 * indicative of more than just the CPU. For example, machine for which
 * CHIP == INTEL are expected to have 8259A interrupt controller and the
