 ...
 * of rules. (For consitency with the new '#ifdef _ANSI' tests in
 * the headers, _ANSI should really be defined as nothing, but that should
...
/* Keeping everything for ANSI prototypes. */
 ...
 */
#define defined(_MINIX) || _POSIX_C_SOURCE > 0 || defined(_POSIX2_SOURCE)
#undef _POSIX_SOURCE
