...
#define INT2_CTLMASK  0xA1  /* setting bits in this port disable ints */
...
#define SYS386_VECTOR   32  /* except 386 system calls use this */
...
#define AT_WINT_1_IRQ       15  /* at winchester controller 1 */
