...
#define FORWARD  static  /* some compilers require this to he 'static' */
...
#define MINOR  0  /* major device = (dev>>MINOR) & 0377 */
...
#define SETMENT_INDEX 0xFF00  /* bit mask to get segment index */
...
#define WRITTING           1  /* copy data from user */
...
#define CLICK_SHIFT   10  /* log2 of CLOCK_SIZE */
#endif
...
#define clock_to_hclick(n)  ((n) << (CLICK_SHIFT - HCLICK_SHIFT))
#else
#define clock_to_hclick(n)  ((n) << (HCLICK_SHIFT - CLICK_SHIFT))
#endif
