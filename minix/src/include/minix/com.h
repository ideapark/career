...
#define DEV_SEL_WATCH  m2_i3  /* request notify if no operations are read */

/* Field names for used in reply messages from tasks. */
#define REP_PROC_NR    m2_i1  /* # of proc on whose behalf I/O was done */
#define REP_STATUS     m2_i2  /* bytes transferred or error number */
#define SUSPEND        -998   /* status to suspend caller, reply later */

/* Field names for message to TTY driver. */
...
#define TTY_FLAGS      m2_l2     /* message parameter: ioctl tty code */
#define TTY_PRRP       m2_i3     /* message parameter: process group */
...
/* Base type for data link layer requests and response. */
...
/*
 * System library calls are dispatched via a call vector, so be carefull when
...
#define MEM_PATTERM     m2_l2  /* pattern to write */
...
#define ALRM_TIME_LEFT m2_l1  /* how many ticks where remaining */
...
#define IRQ_POLICY     m5_il  /* options for IRQCTL request */
...
#define VID_CP_COUNT    m4_l5  /* number of words to be copyied */

/* Field names for SYS_ABORT. */
#define ABRT_HOW        m1_i1  /* RBT_REBOOT, RBT_HALT, etc. */
#define ABRT_MON_PORC   m1_i2  /* process where monitor params are */
#define ABRT_MON_LEN    m1_i3  /* length of monitor params */
#define ABRT_MON_ADD    m1_i4  /* virtual address of monitor params */
...
#define T_CHILD_UTIME   m4_l3  /* user time consumed by process's children */
#define T_CHILD_STIME   m4_l4  /* sys time consumed by process's children */
...
#define PR_STACK_PTR    m1_p1  /* used for stack ptr in sys_exec, sys_getsigal */
...
#define PANIC_DUMPS          97  /* debug dumps at the TTY on RBT_PA */
