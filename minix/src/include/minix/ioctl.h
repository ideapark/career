/*
 * minix/ioctl.h - Ioctl helper definitions.
 *
 ...
 * of the parameter in the high-order word. The 3 high bits of the high-order
 * word are used to encode the in/out/void status of the parameter.
 */
#define _IOCPARM_MASK   0x1FFF
#define _IOC_VOID       0x20000000
#define _IOCTYPE_MASK   0x5555
