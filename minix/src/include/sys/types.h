 ...
 * It is considered godd programming practice to use these definitions,
...
typedef unsigned short bitchunk_t;  /* collections of bits in a bitmap */
 ...
 * definitions (for maximum protability). When a short, such as dev_t, is
 ...
 * expects. Thus using dev_t in a prototype would be incorrect. It would
 * insufficient to just use int instead of dev_t in the prototypes, but dev_t
 * is clearer.
 */
typedef int           Dev_t;
 ...
 * usngiend. When the compiler is not ANSI, there is usually no loss of
 * unsignedness, and there are usually no prototypes of the promoted type
