 ...
 * the same as umap_local(proc_ptr, D, vir, sizeof(*vir)), but less constly.
 */
 ...
 * itself. So it translate '&struct_ptr->field' back to 'struct_ptr'.
 */
...
#define CHUNNK_OFFSET(bit)        ((bit)%BITCHUNK_BITS)
