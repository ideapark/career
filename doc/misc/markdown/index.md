...
formatting to HTML. See the [Syntax][syntax] page for details pertaining
to Markdown's formatting syntax.
...
[Michel Fortin][] has ported Markdown to PHP; it's a splendid port, and highly
recommended for anyone looking for a PHP implementation of Markdown.
