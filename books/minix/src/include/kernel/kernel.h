...
/* The following are so basic, call the *.c files get them automatically. */
#include <minix/config.h>   /* global configration, MUST be first */
...
#include "type.h"           /* type definition, MUST be third */
