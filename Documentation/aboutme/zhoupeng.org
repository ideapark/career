...
- 擅长: Golang, Linux, C, Testing, Git, Amazon Web Service
- 熟练: Shell, Python
...
(https://github.com/lockrecv/more/tree/master/apps/reporter)

** sysstat: Linux内存,线程,中断性能数据采集
(https://github.com/lockrecv/more/tree/master/apps/sysstat)

** kiss: Linux工具集迷你C库
(https://github.com/lockrecv/more/tree/master/apps/libkiss)

** less: Unix KISS哲学思想示例
(https://github.com/lockrecv/more/tree/master/apps/less/SUMMARY.md)

** tank: 坦克大战游戏简化版
(https://github.com/lockrecv/more/tree/master/apps/tank)
