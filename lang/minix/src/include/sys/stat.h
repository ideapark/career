...
/*
 * The ugly casts on only some of the definitions are to avoid suprising signed
...
#define S_IRWXU  00700  /* owner: rws------ */
...
#define S_ISCHR(m)   (((m) & S_IFMT) == S_IFCHR)  /* is a char special */
#define S_ISBLK(m)   (((m) & S_IFMT) == S_IFBLK)  /* is a block special */
