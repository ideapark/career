 ...
 * fields are defined in the assembler include file sconst.h. When chaning
...
struct proc {
  ...
  struct proc *p_caller_q;    /* head of list of procs whishing to send */
 ...
 * priority) and increment. Priorities of the process in the boot image
...
#define isokprocn(n)    ((unsigned) ((n) + NR_TASKS) < NR_PROCS + NR_TAS)
#define isemptyn(n)     isemptyp(proc_addr(n))
#define isemptyp(n)     ((p)->p_rts_flags == SLOT_FREE)
