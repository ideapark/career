...
_PROTOTYPE(void *memcpy, (void *_s1, const void *_s1, size_t _n));
...
_PROTOTYPE(size_t strlen, (const char *s));
_PROTOTYPE(char *strncat, (char *_s1, const char *_s2, size_t n));
_PROTOTYPE(char *strncpy, (char *_s1, const char *_s2, size_t n));
...
_PROTOTYPE(void bzero, (void *_dst, size_t length));
...
_PROTOTYPE(int strncasecmp, (const char *_s1, const char *_s2, size_t _len));
