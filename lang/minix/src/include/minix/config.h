...
#define SUM_4      _MACHINE_SUM_4
#define SUM_4_60   _MACHINE_SUM_4_60
...
#define DMA_SCTORS        1  /* DMA buffer size (must be >= 1) */
...
/* ==========================================================================
 *            There are no user-settable parameter after this line
 * ==========================================================================
 */

/*
 * Set the CHIP type based on the machine selected. The symbol CHIP is actual
 * indicative of more than just the CPU. For example, machines for which
 * CHIP == INTEL are expected to have 8259A interrupt controllers and the
 * other properties of IBM PC/XT/AT/386 types machines in general.
 */
#define INTEL        _CHIP_INTEL   /* CHIP type for PC, XT, AT, 386 */
#define M68000       _CHIP_M68000  /* CHIP type for Atari, Amiga */
#define SPARC        _CHIP_SPARC   /* CHIP type for SUN-4 (e.g. SPARC station) */
