...
/*
 * Device table. This table is indexed by major device number. It providers
...
#define NR_DEVICES    32  /* number of (major/minor device) */
...
/* Full device numbers that are special to be boot monitor and FS. */
