...
and other documents, see [[https://golang.org][golang.org]].
...
For the conversion of non-constant numeric values, the following rules apply:
    ...
    4) When converting an integer or floating-point number to a floating-point
...
In all non-constant conversions involving floating-point or complex values, if
the result type cannot represent the value the conversion succeeds but the
