...
static void usageError(char *progName, char *msg, Boolean shortUsage)
{
	if (msg != NULL)
		fprintf(stderr, "%s\n", msg);
 ...
 */
static Boolean parseEntrySpec(char *entryStr, struct AccessControlEntry *ace, Boolean permsReqd)
{
	char *colon1, *colon2;
 ...
 * error return -1.
 */
static int parseACL(char *aclStr, struct AccessControlEntry aclist[], Boolean permsReqd)
{
